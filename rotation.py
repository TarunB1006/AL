...
def get_datasets():
    ...
    trainset = RotationLoader(path=dataset_path, is_train=True, transform=transform_train)
    testset = RotationLoader(path=dataset_path, is_train=False, transform=transform_test)
...
if __name__ == '__main__':
    ...
    net = models_dict[args.net](num_classes=102)
    net = net.to(device)
